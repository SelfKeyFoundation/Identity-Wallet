...
export const ContactAllowanceListRow = withStyles(styles)(({ classes, allowance }) => (
...
export const ContractAllowanceList = withStyles(styles)(({ classes, allowances, tokens }) => {
	return (
