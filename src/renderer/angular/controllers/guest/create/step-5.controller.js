...
GuestKeystoreCreateStep5Controller.$inject = ["$rootScope", "$scope", "$log", "$state", "$stateParams", "$mdDialog", "$timeout", "SqlLiteService", "RPCService", "CommonService", "SelfkeyService"];
