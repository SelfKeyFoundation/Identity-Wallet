...
export const PassportsPaymentComplete = withStyles(styles)(props => {
				...
				<div className={classes.content}>
					<div className={classes.description}>
						<Typography variant="h1" gutterBottom>
							Passport/Residency KYC Process Started
						</Typography>
						...
						<Typography variant="body2" gutterBottom>
							...
							to continue the process. If you have any questions in the meantime, you
							can reach us at:
						</Typography>
...
export default PassportsPaymentComplete;
