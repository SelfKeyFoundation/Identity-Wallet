...
class PassportsProcessStartedContainerComponent extends PureComponent {
	onBackClick = () => this.props.dispatch(push(MARKETPLACE_PASSPORTS_ROOT_PATH));
...
const styledComponent = withStyles(styles)(PassportsProcessStartedContainerComponent);
const connectedComponent = connect(mapStateToProps)(styledComponent);
export { connectedComponent as PassportsProcessStartedContainer };
