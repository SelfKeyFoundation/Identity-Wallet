...
const ProgramRow = withStyles(styles)(({ classes, program, onDetails, keyRate }) => {
	...
	return (
		<TableRow className={classes.tableRow}>
			...
			<TableCell>
				<Typography variant="h6">{data.timeToPermanentResidencyYears}</Typography>
			</TableCell>
			<TableCell>
				<Typography variant="h6">{data.timeToCitizenship}</Typography>
			</TableCell>
			<TagTableCell className={classes.goodForCell}>
				<Grid container>
			...
			<TableCell className={classes.costCell}>
				<ProgramPrice label="$" price={200} rate={keyRate} />
			</TableCell>
...
const ResidenciesListTable = withStyles(styles)(
	({ classes, type, keyRate, inventory = [], onDetails, className }) => {
		return (
			<Table className={classNames(classes.table, className)}>
				<TableHead>
					<LargeTableHeadRow>
						...
						<TableCell className={classes.costCell}>
							<Typography variant="overline">Time to Permanent Residency</Typography>
						</TableCell>
						<TableCell className={classes.costCell}>
							<Typography variant="overline">Time to Citizenship</Typography>
						</TableCell>
						<TableCell className={classes.costCell}>
							<Typography variant="overline">Investment Type</Typography>
						</TableCell>
						<TableCell className={classes.costCell}>
							<Typography variant="overline">Investment Amount</Typography>
						</TableCell>
						<TableCell className={classes.costCell}>
...
export default ResidenciesListTable;
export { ResidenciesListTable };
