...
/**
 * This configuration helps ReactNative implemenation
 *
 */
const tabs = [
	{
 ...
 *
 */
export const IncorporationDetailsPageTabs = withStyles(styles)(
...
export default IncorporationDetailsPageTabs;
