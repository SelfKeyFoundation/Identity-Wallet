	...
	Main: [
		{
			...
			data: {
				...
				createdTime: '2018-08-27T05:16:00.000Z'
			}
		},
		{
			id: 2,
			data: {
				...
				createdTime: '2017-08-01T07:24:03.000Z'
			}
		},
		{
			id: 86,
			data: {
				...
				createdTime: '2017-08-01T07:25:48.000Z'
			}
		},
		{
			id: 8,
			data: {
				...
				createdTime: '2017-08-01T07:40:52.000Z'
			}
		},
		{
			id: 31,
			data: {
				...
				createdTime: '2017-08-01T07:56:45.000Z'
			}
		}
	],
	Corporations: [
		{
			...
			data: {
				...
				fields: {
					...
					'Audited accounts': true,
					'Capital currency': ['AED', 'USD'],
					'Minimum directors': '1',
					'Electronic signature': true,
					'Minimum shareholders': '1',
					'Minimum issued capital': 'Varies',
					'Minimum paid up capital': 'Varies',
				...
				createdTime: '2018-10-07T04:00:47.000Z'
			}
		},
		{
			id: 1,
			data: {
				id: 'recdnPQryFcSTWI8l',
				fields: {
					AEOI: '2018',
					Region: 'Antigua and Barbuda',
					'Field 36':
					...
					'Country code': 'AG',
					'Legal framework':
						'International Business Corporation Act (As amended 1995-2005)',
					'Capital currency': ['USD', 'Any'],
					'Online_Registry\n': 'Yes',
					'Minimum directors': '1',
					Company_Register_URL: 'http://www.fsrc.gov.ag/',
					'Electronic signature': true,
					'Minimum shareholders': '1',
					Company_Register_Name: 'FSRC',
					Registered_Agent_List: 'http://www.fsrc.gov.ag/',
					'Minimum issued capital': 'USD 1',
					'Bearer shares permitted': true,
				...
				createdTime: '2017-07-13T23:51:35.000Z'
			}
		}
	],
	LLCs: [
		{
			...
			data: {
				...
				fields: {
					...
					'Legal framework': 'Law 4 of 2009 regulating limited liability companies',
					'Minimum members': '2',
					'Capital currency': ['USD', 'Any'],
					'Online_Registry\n': 'No',
					Company_Register_URL: 'www.registro-publico.gob.pa/',
					'Electronic signature': true,
					Company_Register_Name: 'Registro Publico de Panama',
					'Tax transparent entity': true,
					'Minimum paid up capital': '-',
					'Foreign-ownership allowed': '100%',
					'Redomiciliation permitted': true,
					'Audited accounts exemption': true,
					'Minimum registered capital': 'USD 1',
					'Corporate manager permitted': true,
					'Corporate members permitted': true,
					'Registered office or agent required': true
				},
				createdTime: '2017-07-09T09:37:01.000Z'
			}
		}
	],
	Taxes: [
		{
			id: 105,
			data: {
				id: 'receR1hSGniztzAQb',
				fields: {
					Country: 'Abu Dhabi Global Markets',
					'Company code': 'AE3i',
					'Country code': 'AE',
				...
				createdTime: '2018-08-27T05:30:44.000Z'
			}
		},
		{
			id: 110,
			data: {
				id: 'recMb0HXJv11BxxwH',
				fields: {
				...
				createdTime: '2018-10-07T04:04:17.000Z'
			}
		},
		{
			id: 3,
			data: {
				id: 'recy6xQVBpsmRJZ15',
				fields: {
				...
				createdTime: '2017-07-21T23:56:03.000Z'
			}
		},
		{
			id: 64,
			data: {
				id: 'recyUIokGpM3IJYaj',
				fields: {
					Country: 'Panama',
					'VAT Rate': '7%',
					'Company code': 'PA2i',
					...
					'Social Security Employee': '9.75%',
					'Social Security Employer': '13.5%',
					'Inventory methods permitted': ['FIFO', 'Average cost'],
					'Losses carryforward (years)': '5',
					'Dividends Witholding Tax Rate': '10%',
					'Interests Witholding Tax Rate': '12.5%',
					'Offshore Income Tax Exemption': true,
					'Royalties Witholding Tax Rate': '12.5%',
					'Dividends Withholding Tax Rate': '10%',
					'Interests Withholding Tax Rate': '12.5%',
					'Royalties Withholding Tax Rate': '12.5%',
					'Offshore dividends tax exemption': true,
					'Offshore capital gains tax exemption': true
				},
				createdTime: '2017-07-21T23:56:03.000Z'
		...
		},
		{
			...
			data: {
				...
				createdTime: '2017-07-22T00:19:27.000Z'
			}
		}
	],
	Foundations: [
		{
			...
			data: {
				...
				fields: {
					...
					'Country code': 'AT',
					'Legal framework':
						'Austrian Private Foundation Act (Privatstiftungsgesetz, PSG) 1993.',
					'Regulatory body': 'Financial Market Authority Austria',
					'Name of Foundation': 'Private Foundation',
					'Minimum council members': '3',
					'Corporate founder permitted': true,
					'Initial endowment of assets': 'EUR 70,000',
					'Charitable purposes permitted': true,
					'Beneficiaries have right to information': true,
					'Beneficiaries not disclosed in a public registry': true
				},
				createdTime: '2017-07-06T04:07:39.000Z'
			}
		}
	],
	Trusts: [
		{
			...
			data: {
				...
				fields: {
					...
					'Date of Laws': '1984',
					'Link to Github':
						'https://github.com/Horizon88/incorporationsio/wiki/CK_Trust_Act',
					'Legal framework': 'Cook Islands International Trust Act',
					'Settlor-beneficiary': true,
					'Bankruptcy protection': true,
					'Spendthrift provisions': true,
					'Choice of law is binding': true,
					'Ignore foreign judgements': true,
					'link to trust company act':
						'http://www.cookislandsfinance.com/legislation/Trustee-Companies-Act-2014.pdf',
					'Ease to setup bank account': ['Difficult'],
					'Settlor can retain control': ['Yes'],
					'Custodian trustee permitted': true,
					'Avoidance of forced heirship': true,
					'Community property provisions': true,
					'Separation of creditor claims': true,
					'Protection from immigrant trusts': true,
					'Specific exclusion of foreign law': ['Yes'],
					'Exclusion of Statute of Elizabeth laws': true,
					'Creditor must prove fraudulent transfer': true,
					'Clear definition of fraudulent transfers': true,
					'Statutory limitation on fraudulent transfer': true,
					'Statutory limitation on fraudulent transfer (years)': '1'
				},
				createdTime: '2017-07-06T06:19:12.000Z'
			}
		}
	],
	EN: [
		{
			...
			data: {
				...
				fields: {
					...
					'company title': 'Private company limited by shares',
					country_details:
				...
				createdTime: '2018-10-07T01:26:03.000Z'
			}
		},
		{
			ref: '',
			...
			data: {
				...
				createdTime: '2017-06-25T07:05:01.000Z'
			}
		},
		{
			ref: '',
			...
			data: {
				...
				createdTime: '2017-06-29T04:30:43.000Z'
			}
		},
		{
			ref: '',
			lang: 'EN',
			data: {
				id: 'recUlc8qkjDCyIFcs',
				fields: {
					Region: 'Austria',
					Country: 'AT',
					'Company code': 'AT2i',
					'company title': 'Privatstiftung (Private Foundation)',
					country_details:
				...
				createdTime: '2017-07-14T03:43:21.000Z'
			}
		},
		{
			ref: '',
			...
			data: {
				...
				createdTime: '2017-07-14T03:37:19.000Z'
			}
		}
	]
});
