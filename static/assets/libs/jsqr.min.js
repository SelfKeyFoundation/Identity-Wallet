 ...
 * Original file: /npm/jsqr@1.2.0/dist/jsQR.js
 *
...
!(function(o, e) {
	...
	return (function(o) {
		...
		return (
			...
			(r.d = function(o, e, t) {
				r.o(o, e) ||
					Object.defineProperty(o, e, { configurable: !1, enumerable: !0, get: t });
			}),
			(r.n = function(o) {
				var e =
					o && o.__esModule
		...
		function(o, e, r) {
			...
			var c = (function() {
				...
				return (
					(o.prototype.multiply = function(o, e) {
						return 0 === o || 0 === e
							? 0
							: this.expTable[
					...
					return (
						...
						(o.prototype.addOrSubtract = function(e) {
							...
							var r = this.coefficients,
								c = e.coefficients;
							r.length > c.length && ((r = (s = [c, r])[0]), (c = s[1]));
							for (
								var s,
									a = new Uint8ClampedArray(c.length),
									d = c.length - r.length,
									n = 0;
								n < d;
								n++
								...
								a[n] = c[n];
							for (n = d; n < c.length; n++) a[n] = t.addOrSubtractGF(r[n - d], c[n]);
						...
						(o.prototype.multiplyPoly = function(e) {
							...
							for (
								var r = this.coefficients,
									...
									s = e.coefficients,
									a = s.length,
									d = new Uint8ClampedArray(c + a - 1),
									n = 0;
								n < c;
								n++
							)
								for (var l = r[n], i = 0; i < a; i++)
									d[n + i] = t.addOrSubtractGF(
										d[n + i],
										this.field.multiply(l, s[i])
									);
		...
		function(o, e, r) {
			...
			var n = { inversionAttempts: 'attemptBoth' };
			function l(o, e, r, c) {
				void 0 === c && (c = {});
				var s = n;
				...
				var a =
						'attemptBoth' === s.inversionAttempts ||
						'invertFirst' === s.inversionAttempts,
					l =
						'onlyInvert' === s.inversionAttempts ||
						'invertFirst' === s.inversionAttempts,
		...
		function(o, e, r) {
			...
			e.binarize = function(o, e, r, n) {
				if (o.length !== e * r * 4) throw new Error('Malformed data passed to binarizer.');
				for (var l = new d(e, r), i = 0; i < e; i++)
					for (var B = 0; B < r; B++) {
						var k = o[4 * (B * e + i) + 0],
							u = o[4 * (B * e + i) + 1],
							C = o[4 * (B * e + i) + 2];
						l.set(i, B, 0.2126 * k + 0.7152 * u + 0.0722 * C);
					}
				for (
					var m = Math.ceil(e / c), f = Math.ceil(r / c), w = new d(m, f), P = 0;
					P < f;
					P++
				)
					for (var v = 0; v < m; v++) {
						...
						for (B = 0; B < c; B++)
							for (i = 0; i < c; i++) {
								var y = l.get(v * c + i, P * c + B);
								(h += y), (p = Math.min(p, y)), (b = Math.max(b, y));
							}
						var g = h / Math.pow(c, 2);
						if (b - p <= s && ((g = p / 2), P > 0 && v > 0)) {
							var x =
								(w.get(v, P - 1) + 2 * w.get(v - 1, P) + w.get(v - 1, P - 1)) / 4;
							p < x && (g = x);
						}
						w.set(v, P, g);
					}
				var M = t.BitMatrix.createEmpty(e, r),
					L = null;
				for (n && (L = t.BitMatrix.createEmpty(e, r)), P = 0; P < f; P++)
					for (v = 0; v < m; v++) {
						for (
							var N = a(v, 2, m - 3), I = a(P, 2, f - 3), O = ((h = 0), -2);
							O <= 2;
							O++
						)
							for (var z = -2; z <= 2; z++) h += w.get(N + O, I + z);
						var S = h / 25;
						for (O = 0; O < c; O++)
							for (z = 0; z < c; z++) {
								(i = v * c + O), (B = P * c + z);
								var X = l.get(i, B);
								M.set(i, B, X <= S), n && L.set(i, B, !(X <= S));
							}
					}
				return n ? { binarized: M, inverted: L } : { binarized: M };
			};
		},
		function(o, e, r) {
			'use strict';
					...
					var c = i[r.dataMask],
						...
						a = (function(o) {
							...
							for (var c = 0, s = o.alignmentPatternCenters; c < s.length; c++)
								for (
									var a = s[c], d = 0, n = o.alignmentPatternCenters;
									d < n.length;
									d++
								) {
									var l = n[d];
			...
			function k(o) {
				...
				var t = (function(o, e, r) {
					...
					if (
						...
						return null;
					o = o.slice(0, s);
					for (var a = t.ecBlocks[0].dataCodewordsPerBlock, d = 0; d < a; d++)
						for (var n = 0, l = c; n < l.length; n++) l[n].codewords.push(o.shift());
			...
			e.decode = function(o) {
				...
				for (var r = 0; r < o.width; r++)
					for (var t = r + 1; t < o.height; t++)
						o.get(r, t) !== o.get(t, r) &&
							(o.set(r, t, !o.get(r, t)), o.set(t, r, !o.get(t, r)));
				return k(o);
			};
		},
		function(o, e, r) {
			...
			function d(o, e) {
				for (var r = [], t = '', c = [10, 12, 14][e], s = o.readBits(c); s >= 3; ) {
					...
					var a = Math.floor(l / 100),
						...
						n = l % 10;
					r.push(48 + a, 48 + d, 48 + n),
						(t += a.toString() + d.toString() + n.toString()),
						(s -= 3);
				}
				if (2 === s) {
					if ((l = o.readBits(7)) >= 100)
						throw new Error('Invalid numeric value above 99');
					(a = Math.floor(l / 10)), (d = l % 10);
					r.push(48 + a, 48 + d), (t += a.toString() + d.toString());
				} else if (1 === s) {
					var l;
			...
			e.decode = function(o, e) {
				for (
					...
					if (f === c.ECI)
						0 === u.readBits(1)
							? m.chunks.push({ type: t.ECI, assignmentNumber: u.readBits(7) })
							: 0 === u.readBits(1)
							? m.chunks.push({ type: t.ECI, assignmentNumber: u.readBits(14) })
							: 0 === u.readBits(1)
							? m.chunks.push({ type: t.ECI, assignmentNumber: u.readBits(21) })
							: m.chunks.push({ type: t.ECI, assignmentNumber: -1 });
					else if (f === c.Numeric) {
						var w = d(u, C);
						(m.text += w.text),
							(r = m.bytes).push.apply(r, w.bytes),
							m.chunks.push({ type: t.Numeric, text: w.text });
					} else if (f === c.Alphanumeric) {
						var P = l(u, C);
						(m.text += P.text),
							(a = m.bytes).push.apply(a, P.bytes),
							m.chunks.push({ type: t.Alphanumeric, text: P.text });
					} else if (f === c.Byte) {
						var v = i(u, C);
						(m.text += v.text),
							(n = m.bytes).push.apply(n, v.bytes),
							m.chunks.push({ type: t.Byte, bytes: v.bytes, text: v.text });
					} else if (f === c.Kanji) {
						var h = B(u, C);
						(m.text += h.text),
							(k = m.bytes).push.apply(k, h.bytes),
							m.chunks.push({ type: t.Kanji, bytes: h.bytes, text: h.text });
					}
				}
			};
		},
		function(o, e, r) {
			...
			var t = (function() {
				...
				return (
					(o.prototype.readBits = function(o) {
		...
		function(o, e, r) {
			...
			e.decode = function(o, e) {
				...
				r.set(o);
				for (
					var s = new t.default(285, 256, 0),
						a = new c.default(s, r),
						d = new Uint8ClampedArray(e),
						n = !1,
						l = 0;
					l < e;
					l++
				...
				if (!n) return r;
				var B = new c.default(s, d),
					k = (function(o, e, r, t) {
						e.degree() < r.degree() && ((e = (f = [r, e])[0]), (r = f[1]));
						for (var c = e, s = r, a = o.zero, d = o.one; s.degree() >= t / 2; ) {
							var n = c,
								l = a;
							if (((a = d), (c = s).isZero())) return null;
							s = n;
							for (
								var i = o.zero, B = c.getCoefficient(c.degree()), k = o.inverse(B);
								s.degree() >= c.degree() && !s.isZero();

							) {
								var u = s.degree() - c.degree(),
									C = o.multiply(s.getCoefficient(s.degree()), k);
								(i = i.addOrSubtract(o.buildMonomial(u, C))),
									(s = s.addOrSubtract(c.multiplyByMonomial(u, C)));
							}
							if (
								((d = i.multiplyPoly(a).addOrSubtract(l)), s.degree() >= c.degree())
							)
								return null;
						}
						var m = d.getCoefficient(0);
						if (0 === m) return null;
						var f,
							w = o.inverse(m);
						return [d.multiply(w), s.multiply(w)];
				...
				var u = (function(o, e) {
					...
					for (var t = new Array(r), c = 0, s = 1; s < o.size && c < r; s++)
						0 === e.evaluateAt(s) && ((t[c] = o.inverse(s)), c++);
					return c !== r ? null : t;
				})(s, k[0]);
				if (null == u) return null;
				for (
					var C = (function(o, e, r) {
							for (var c = r.length, s = new Array(c), a = 0; a < c; a++) {
								for (var d = o.inverse(r[a]), n = 1, l = 0; l < c; l++)
									a !== l &&
										(n = o.multiply(
											n,
											t.addOrSubtractGF(1, o.multiply(r[l], d))
										));
								(s[a] = o.multiply(e.evaluateAt(d), o.inverse(n))),
									0 !== o.generatorBase && (s[a] = o.multiply(s[a], d));
							}
							return s;
						})(s, k[1], u),
						m = 0;
		...
		function(o, e, r) {
			...
			e.extract = function(o, e) {
				for (
					var r,
						...
						a = (function(o, e, r, t) {
							...
							{ x: 3.5, y: 3.5 },
							{ x: e.dimension - 3.5, y: 3.5 },
							{ x: e.dimension - 6.5, y: e.dimension - 6.5 },
							{ x: 3.5, y: e.dimension - 3.5 }
						),
						d = c(e.topLeft, e.topRight, e.alignmentPattern, e.bottomLeft),
						n = ((s = a),
						{
						...
						l = t.BitMatrix.createEmpty(e.dimension, e.dimension),
						i = function(o, e) {
				...
				return { matrix: l, mappingFunction: i };
			};
		},
		function(o, e, r) {
			'use strict';
			...
			function n(o, e, r, t) {
				var c,
					...
					d,
					n,
					l = [{ x: Math.floor(o.x), y: Math.floor(o.y) }],
				...
				for (
					...
					var v = i ? P : w,
						h = i ? w : P;
					if (r.get(v, h) !== f && ((f = !f), l.push({ x: v, y: h }), l.length === t + 1))
						break;
					if ((u += k) > 0) {
						if (P === n) break;
						(P += m), (u -= B);
				...
				for (var p = [], b = 0; b < t; b++)
					l[b] && l[b + 1] ? p.push(a(l[b], l[b + 1])) : p.push(0);
				return p;
			}
			function l(o, e, r, t) {
				var c,
					s = e.y - o.y,
					a = e.x - o.x,
					d = n(o, e, r, Math.ceil(t / 2)),
					l = n(o, { x: o.x - a, y: o.y - s }, r, Math.ceil(t / 2)),
					i = d.shift() + l.shift() - 1;
			...
			function i(o, e) {
				...
				return (
					...
					{ averageSize: r, error: t }
				);
			}
			function B(o, e, r) {
				try {
					var t = l(o, { x: -1, y: o.y }, r, e.length),
						c = l(o, { x: o.x, y: -1 }, r, e.length),
						s = l(
							o,
						...
						C = (d.averageSize + n.averageSize + B.averageSize + k.averageSize) / 4;
					return (
						u +
						(Math.pow(d.averageSize - C, 2) +
							Math.pow(n.averageSize - C, 2) +
							Math.pow(B.averageSize - C, 2) +
							Math.pow(k.averageSize - C, 2)) /
							C
					);
				} catch (o) {
					return 1 / 0;
			...
			e.locate = function(o) {
								...
								var a = 0,
									...
									k = function(e) {
										...
										if (n === l) a++;
											...
											(B = [B[1], B[2], B[3], B[4], a]), (a = 1), (l = n);
											var k = d(B) / 7,
												u =
													Math.abs(B[0] - k) < k &&
													Math.abs(B[1] - k) < k &&
													Math.abs(B[2] - 3 * k) < 3 * k &&
													Math.abs(B[3] - k) < k &&
													Math.abs(B[4] - k) < k &&
													!n,
												C = d(B.slice(-3)) / 3,
											...
											if (m) {
												var v,
													h = e - B[4],
													p = h - B[3];
												(P = { startX: p, y: t, endX: h }),
													(v = i.filter(function(o) {
														return (
															(p >= o.bottom.startX &&
																p <= o.bottom.endX) ||
															(h >= o.bottom.startX &&
				...
				var C = e
					...
					.map(function(o, e, r) {
						...
						var s = o.score + c[0].score + c[1].score;
						return { points: [o].concat(c.slice(0, 2)), score: s };
					})
					.filter(function(o) {
						return !!o;
					})
				...
				var m,
					...
					w = (function(o, e, r) {
						...
						return (
							k >= B && k >= u
								? ((t = (d = [e, o, r])[0]), (c = d[1]), (s = d[2]))
								: u >= k && u >= B
								? ((t = (n = [o, e, r])[0]), (c = n[1]), (s = n[2]))
								: ((t = (l = [o, r, e])[0]), (c = l[1]), (s = l[2])),
							(s.x - c.x) * (t.y - c.y) - (s.y - c.y) * (t.x - c.x) < 0 &&
								((t = (i = [s, t])[0]), (s = i[1])),
							{ bottomLeft: t, topLeft: c, topRight: s }
						);
					})(C[0].points[0], C[0].points[1], C[0].points[2]),
					P = w.topRight,
					v = w.topLeft,
					h = w.bottomLeft;
				try {
					(p = (function(o, e, r, t) {
						...
						var s = Math.round(a(o, e) / c),
							n = Math.round(a(o, r) / c),
							i = Math.floor((s + n) / 2) + 7;
						switch (i % 4) {
							case 0:
								i++;
								break;
						...
						return { dimension: i, moduleSize: c };
					})(v, P, h, o)),
						(m = p.dimension),
						(f = p.moduleSize);
				} catch (o) {
				...
				var p,
					...
					g = (a(v, h) + a(v, P)) / 2 / f,
					x = 1 - 3 / g,
					M = { x: v.x + x * (b - v.x), y: v.y + x * (y - v.y) },
					L = n
						.map(function(e) {
							var r =
									(e.top.startX + e.top.endX + e.bottom.startX + e.bottom.endX) /
									4,
								t = (e.top.y + e.bottom.y + 1) / 2;
							if (o.get(Math.floor(r), Math.floor(t))) {
								var c = [
									e.top.endX - e.top.startX,
									e.bottom.endX - e.bottom.startX,
									e.bottom.y - e.top.y + 1
					...
					N = g >= 15 && L.length ? L[0] : M;
				return {
					alignmentPattern: { x: N.x, y: N.y },
					bottomLeft: { x: h.x, y: h.y },
					dimension: m,
					topLeft: { x: v.x, y: v.y },
