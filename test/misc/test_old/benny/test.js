...
function regStep(selector, delayTime) {
    return new Promise((resolve, reject) => {
        delay(1000)
            ...
            .then(() =>
                resolve(console.log(chalk.green(selector + " Step Done")))
            )
            .catch(err => {
                reject(err);
            });
...
function createNewWalletTest() {
    return new Promise((resolve, reject) => {
        init("Create New Wallet With Password")
            ...
            .then(() =>
                resolve(
                    console.log(chalk.green("Create New Wallet Tests Done"))
                )
            )
            .catch(err => {
                reject(err);
...
function privateKeyImportTest() {
    return new Promise((resolve, reject) => {
        init("Import Wallet From Private Key")
            ...
            .then(() =>
                resolve(
                    console.log(chalk.green("Private Key Import Tests Done"))
                )
            )
            .catch(err => {
                reject(err);
