Feature: Apply to Incorporations Program
	...
	Scenario: Initial application without KYC requirements
		...
		When user clicks the "Start Incorporation" button
		Then ...

	Scenario: Existing ongoing application process
		Given incorporations detailed program screen is opened
		And an existing application process exists for that program
		Then the "Start incorporations" button should be deactivated
	...
	Scenario: Ask for payment with KEY tokens
		Given incorporations detailed program screen is opened
		And user clicked the "Start Incorporation" button
	...
	Scenario: Successful payment for incorporations
		Given incorporations detailed program screen is opened
	...
	Scenario: Failed payment for incorporations
		Given incorporations detailed program screen is opened
		And payment confirmation screen is showing up
		When user clicks "Pay"
		And payment fails
